...
```{r}
Delays_data <- data %>%
  select(airline_name, Delayed, flight, On_time) %>%
...
```
 ...
 descriptions of analysis, and conclusions:
...
# select the airline_name, Delayed, flight, On_time.
#group_by the airline_name.
#  sum of Delayed data, flight, calculate Delay Rate
# plot two  graphs to see the total flight by airline and delay rate by airline
